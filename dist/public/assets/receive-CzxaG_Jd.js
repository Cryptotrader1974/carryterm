import{cJ as k,fl as $,c_ as v,eK as y,cL as x,ej as C,ca as w,el as N,L as c,bv as p,w as m,bB as h,bJ as R,eQ as A,cb as f,d$ as S,bY as I,bl as T,a2 as _,fd as b}from"./index-B_sODcps.js";const O=k`
  button {
    width: 100%;
    display: flex;
    align-items: center;
...
`;var g=function(e,t,o,r){var s=arguments.length,i=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(i=(s<3?n(i):s>3?n(t,o,i):n(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};let u=class extends C{constructor(){super(...arguments),this.networkImages=[""],this.text=""}render(){return w`
    ...
    </wui-flex>`}};u.styles=[$,v,O];g([y({type:Array})],u.prototype,"networkImages",void 0);g([y()],u.prototype,"text",void 0);u=g([x("wui-compatible-network")],u);const E=k`
...
`;var d=function(e,t,o,r){var s=arguments.length,i=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(i=(s<3?n(i):s>3?n(t,o,i):n(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};let l=class extends N{constructor(){super(),this.unsubscribe=[],this.address=c.getAccountData()?.address,this.profileName=c.getAccountData()?.profileName,this.network=c.state.activeCaipNetwork,this.unsubscribe.push(c.subscribeChainProp("accountState",t=>{t?(this.address=t.address,this.profileName=t.profileName):p.showError("Account not found")}),c.subscribeKey("activeCaipNetwork",t=>{t?.id&&(this.network=t)}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){if(!this.address)throw new Error("w3m-wallet-receive-view: No account provided");const t=m.getNetworkImage(this.network);return f` <wui-flex
    ...
    >
      ...
      >
        <wui-qr-code
          ...
          uri=${this.address}
          ?arenaClear=${!0}
          color=${A(h.state.themeVariables["--apkt-qr-color"]??h.state.themeVariables["--w3m-qr-color"])}
    ...
    </wui-flex>`}networkTemplate(){const t=c.getAllRequestedCaipNetworks(),o=c.checkIfSmartAccountEnabled(),r=c.state.activeCaipNetwork,s=t.filter(a=>a?.chainNamespace===r?.chainNamespace);if(S(r?.chainNamespace)===I.ACCOUNT_TYPES.SMART_ACCOUNT&&o)return r?f`<wui-compatible-network
        @click=${this.onReceiveClick.bind(this)}
        text="Only receive assets on this network"
        .networkImages=${[m.getNetworkImage(r)??""]}
      ></wui-compatible-network>`:null;const n=(s?.filter(a=>a?.assets?.imageId)?.slice(0,5)).map(m.getNetworkImage).filter(Boolean);return f`<wui-compatible-network
      @click=${this.onReceiveClick.bind(this)}
      text="Only receive assets on these networks"
      .networkImages=${n}
    ></wui-compatible-network>`}onReceiveClick(){T.push("WalletCompatibleNetworks")}onCopyClick(){try{this.address&&(_.copyToClopboard(this.address),p.showSuccess("Address copied"))}catch{p.showError("Failed to copy")}}};l.styles=E;d([b()],l.prototype,"address",void 0);d([b()],l.prototype,"profileName",void 0);d([b()],l.prototype,"network",void 0);l=d([x("w3m-wallet-receive-view")],l);export{l as W3mWalletReceiveView};
