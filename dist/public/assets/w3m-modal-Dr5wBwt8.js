import{b2 as v,bo as re,bl as l,T as ce,cJ as b,fl as V,cL as m,ej as U,ca as C,eK as W,eR as de,s as H,fd as d,el as R,cb as h,c_ as ue,eM as c,L as f,eQ as S,gm as B,w as F,v as he,Z as K,ac as M,ba as E,U as X,ek as pe,bv as P,t as z,ak as J,bB as me,bJ as ae,eo as fe,r as we}from"./index-CQmdijyv.js";import{P as D}from"./index-B0g5InaO.js";import{S as be}from"./SwapController-XR0REAUd.js";const ne={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){v.shake();return}if(await re.isSIWXCloseDisabled()){v.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&ce.disconnect(),v.close()}},ge=b`
  :host {
    display: block;
